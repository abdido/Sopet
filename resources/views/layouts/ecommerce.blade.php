			...
			<nav class="navbar navbar-expand-lg navbar-light">
				<div class="container-fluid">
                    ...
                    <a class="navbar-brand logo_h" href="{{ url('/') }}">
						<img src="{{ asset('assets/img/brand/sopet-logo.png') }}" width="90" height="90" alt="">
					</a>
			...
			<div class="row">
				<div class="col-lg-3  col-md-6 col-sm-6">
					<div class="single-footer-widget">
						...
						<p>Sopet merupakan sebuah alternatif dokter hewan di kota anda.</p>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="single-footer-widget">
						<h6 class="footer_title">Subscribe</h6>
						<p>Tetap update dengan produk terbaru kami.</p>
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single-footer-widget instafeed">
						<h6 class="footer_title">Feeds</h6>
						<ul class="list instafeed d-flex flex-wrap">
							<li>
								<img src="{{ asset('ecommerce/img/instagram/Image-01.jpg') }}" height="80" width="80" alt="">
							</li>
							<li>
								<img src="{{ asset('ecommerce/img/instagram/Image-02.jpg') }}" height="80" width="80" alt="">
							</li>
							<li>
								<img src="{{ asset('ecommerce/img/instagram/Image-03.jpg') }}" height="80" width="80" alt="">
							</li>
						</ul>
					</div>
				</div>
